...
export function ContactSection() {
  ...
  function prepareDraft(event: FormEvent<HTMLFormElement>) {
    ...
    setDraft(body)
    setCopied(false)
    setFeedback('Your introduction is ready. Choose Email introduction to open your mail app addressed to Om Prakash.')
  }
