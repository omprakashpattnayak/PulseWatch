...
export function ContactSection() {
  ...
  function prepareDraft(event: FormEvent<HTMLFormElement>) {
    ...
    setDraft(body)
    setCopied(false)
    setFeedback('Your introduction is ready. Click Send introduction by email to open your mail app addressed to Om Prakash.')
  }
