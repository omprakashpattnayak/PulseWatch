...
const steps = [
  { icon: Radio, title: 'Collect the signal.', body: 'Read the official USGS earthquake feed directly when the map is opened.' },
...
export function SolutionSection() {
  return (
    <section id="solution" className="solution-section section-surface" aria-labelledby="solution-heading"><div className="page-width project-section">
      ...
      <div className="section-heading-grid"><h2 id="solution-heading">One planet.<br /><span className="text-primary">One clearer picture.</span></h2><div><p>PulseWatch turns live USGS earthquake activity into one interactive map, with location, magnitude, depth, and time visible at a glance.</p><Badge variant="outline" className="prototype-badge"><CircleDot data-icon="inline-start" /> Live USGS feed · Built for clarity</Badge></div></div>
...
const phases = [
  { number: '01', status: 'LIVE NOW', title: 'One map. One feed.', description: 'Keep the live USGS experience reliable, refine the map, and make every event easier to understand.', icon: Layers3 },
