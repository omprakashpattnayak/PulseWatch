...
export function ProblemSection() {
  return (
    <section id="problem" className="project-section problem-section page-width" aria-labelledby="problem-heading">
      ...
      <div className="research-stats" aria-label="Disaster impact context"><div><strong>4.0B+</strong><p>People affected by disasters<br /><small>Long-run global context · UNDRR</small></p></div><div><strong>$2.97T</strong><p>Estimated natural-hazard losses<br /><small>Long-run global context</small></p></div><div><strong>01</strong><p>Unified response view<br /><small>Built for faster context</small></p></div></div><p className="impact-context">Disaster records from the UNDRR and EM-DAT reveal a sharp rise in extreme events. Fragmented feeds across siloed agency portals delay critical emergency intervention.</p>
    </section>
  )
}
...
const phases = [
  ...
  { number: '02', status: 'IN PROGRESS', title: 'Your region. Your alerts.', description: 'Saved regions and alert rules are available for signed-in users; delivery automation and field validation are next.', icon: Bell },
