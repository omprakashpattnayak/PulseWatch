...
export default function CrisisMap({ events, categories, selectedId, onSelect, exploring }: {
  ...
  return (
    <MapContainer center={[19, 12]} zoom={2.25} minZoom={1} maxZoom={6} zoomSnap={0.25} zoomControl={false} attributionControl={false} scrollWheelZoom={true} doubleClickZoom={true} dragging={true} touchZoom={true} keyboard={true} className="crisis-map" aria-label="Interactive demonstration world map of illustrative disaster events">
